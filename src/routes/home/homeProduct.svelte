<div class="flex flex-col justify-between shadow-md dark:hover:bg-neutral-700 bg-neutral-50 hover:bg-neutral-100 dark:bg-neutral-800 rounded-xl h-64 w-52 min-w-[200px] md:w-auto md:max-w-sm px-5 py-3 pt-7 mx-5 lg:mx-5 relative">
