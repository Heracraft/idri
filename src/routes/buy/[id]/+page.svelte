  ...
  <h4 class="text-current !my-2">$2999</h4>
    ...
    <div class="my-4">
      ...
      <div class="flex">
        ...
        <span class="w-5 p-1 h-5 rounded-full mx-2 bg-zinc-500 block"/>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 grid-rows-2 gap-4 text-base my-3">
      ...
      <span class="dark:bg-neutral-700 rounded-xl p-3 flex flex-col">
          ...
          <span class="flex w-fit px-2 pr-4 my-1 rounded items-center bg-primary-800 fill-primary-300">
      ...
      <span class="dark:bg-neutral-700 rounded-xl p-3 flex flex-col">
          ...
          <p class="!my-1 text-neutral-400">12kg</p>
      </span>
